...
\begin{itemize}
    ...
    \item \textbf{Risoluzione tramite \textit{Tree-Climbing}:} Per preservare l'integrità strutturale, l'algoritmo esegue una procedura di risalita in memoria per ciascun paragrafo. Partendo dall'elemento foglia (il comma), risale ricorsivamente la catena dei nodi padri, estraendo il numero e il titolo di ogni livello gerarchico attraversato (Articolo, Capo, Titolo).
\end{itemize}
