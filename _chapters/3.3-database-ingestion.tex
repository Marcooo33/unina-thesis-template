...
\begin{lstlisting}[caption={Esempio di relazione CITES estratta in formato JSON}, label={lst:json-cites}, belowskip=0pt, breaklines=true]
{
  "sourceId": "ente-provincia-taranto__regolamento-iscrizione-elenco-speciale-associazioni-e-organismi-senza-scopo-di-lucro__article-3__paragraph-1",
  "relationshipType": "CITES",
  "targetId": "ente-provincia-taranto__regolamento-iscrizione-elenco-speciale-associazioni-e-organismi-senza-scopo-di-lucro__article-2"
}
\end{lstlisting}

Il metodo \texttt{import\_relationships} esegue di fatto una seconda passata sul grafo e per ogni collegamento estratto dal JSON, l'algoritmo esegue una query Cypher dedicata procedendo alla creazione dell'arco semantico. Inoltre sfruttando l'indicizzazione definita sulla proprietà \texttt{custom\_id}, il motore di Neo4j individua i nodi con tempi di ricerca estremamente ridotti.
...
\begin{lstlisting}[language=json, caption={Esempio reale di un Point vettoriale su Qdrant con Payload}, label={lst:qdrant-payload}, breaklines=true]
{
  ...
  "vector": [/* Rappresentazione numerica dell'embedding testuale */]
}
\end{lstlisting}
